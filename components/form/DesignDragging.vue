    ...
    <el-form label-width="auto">
        <template v-if="props.type === 'attendee'">
            ...
            <OrganismDesignOrganization v-if="isTypeLimited('organization')" class="eventTemplate__draggable"
                draggable="true"
                @dragstart="setOnDrag({ type: 'organization', formField: 'organizer', required: true, })"
                @mouseenter="setOnEnter({ type: 'organization', formField: 'organizer', required: true, })"
                @mouseout="cancelDragging()" :disabled="true" :isDesigning="false">
            </OrganismDesignOrganization>
            <OrganismDesignOrganizationMember v-if="isTypeLimited('organizationMember')"
            ...
            <OrganismDesignUrl v-if="isFormFieldLimited('virtualLocation')" class="eventTemplate__draggable"
                :model-value="virtualLocation" namePlaceholder="視訊會議連結"
                valuePlaceHolder="https://meet.google.com/ve-ko-ss" draggable="true"
                @dragstart="setOnDrag({ type: 'url', formField: 'virtualLocation', })"
                @mouseenter="setOnEnter({ type: 'url', formField: 'virtualLocation', })" @mouseout="cancelDragging()"
                :disabled="true" :isDesigning="false">
            </OrganismDesignUrl>
            <OrganismDesignEventGroup v-if="isTypeLimited('eventGroup')" class="eventTemplate__draggable"
                draggable="true" @dragstart="setOnDrag({ type: 'eventGroup', })"
                @mouseenter="setOnEnter({ type: 'eventGroup', })" @mouseout="cancelDragging()" :disabled="true"
                :isDesigning="false">
            ...
            <OrganismDesignUrl class="eventTemplate__draggable" draggable="true"
                @dragstart="setOnDrag({ type: 'url', })" @mouseenter="setOnEnter({ type: 'url', })"
                @mouseout="cancelDragging()" :disabled="true" :isDesigning="false">
            </OrganismDesignUrl>

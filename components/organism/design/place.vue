<template>
    ...
    <el-form-item v-if="!props.isDesigning" :label="customDesign.label" @dragstart="emit('dragstart')">
        <el-select v-if="customDesign" v-model="customDesign.placeId" :placeholder="placeholder"
        ...
        <el-input v-if="customDesign" class="design__mt" placeholder="地址"
            :model-value="customDesign.placeAddress" :disabled="true"></el-input>
        <!-- <el-form-item label="詳細地址能見度"> -->
        <!-- 購票前可見 -->
        <el-switch v-if="customDesign" v-model="customDesign.placePublicAccess" inline-prompt
    ...
    <MoleculeDesignToolbar v-else-if="customDesign" :loading="isLoading" @dragstart="emit('dragstart')"
        ...
        <template v-slot:default>
            <el-select v-model="customDesign.placeId" :placeholder="placeholder" :clearable="true"

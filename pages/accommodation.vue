<template>
  ...
  <el-dialog v-model="accommodationDialog.visibility" title="成員設定" class="event__template">
    <FormOrganizationMember v-if="accommodationDialog.visibility" v-model="accommodation"
      :mode="accommodationDialog.mode">
